...
const Cart = () => {
  ...
  let total = calTotal(subTotal, text, shipping);
  total = total ? total : 0;
      ...
      <Box style={{ marginTop: "100px" }}>
        ...
        <Grid container spacing={2} style={{ marginTop: "50px" }}>
          <Grid item xs={12} md={8}>
            {cart.map((pd) => (
              <Box
                style={{ borderBottom: "1px solid gray", marginBottom: "15px" }}
              >
                <Card
                  sx={{
                    display: "flex",
                ...
                >
                  ...
                  <Box
                    sx={{ marginTop: { xs: "30px", sm: "30px", md: 0, lg: 0 } }}
                  >
                    <Box>
